...
fFile_10 = TFile(
    "/Users/fmeloni/MuonCollider/MuCData/ntup_photons/ntup_photonGun_10.root", "READ")
fFile_50 = TFile(
    "/Users/fmeloni/MuonCollider/MuCData/ntup_photons/ntup_photonGun_50.root", "READ")
fFile_100 = TFile(
    "/Users/fmeloni/MuonCollider/MuCData/ntup_photons/ntup_photonGun_100.root", "READ")
fFile_500 = TFile(
    "/Users/fmeloni/MuonCollider/MuCData/ntup_photons/ntup_photonGun_500.root", "READ")
fFile_1000 = TFile(
    "/Users/fmeloni/MuonCollider/MuCData/ntup_photons/ntup_photonGun_1000.root", "READ")
fFile_5000 = TFile(
    "/Users/fmeloni/MuonCollider/MuCData/ntup_photons/ntup_photonGun_5000.root", "READ")
...
leg.Draw()
t2_3.DrawLatex(.62, 0.84, 'Photon particle gun')
c2.SaveAs("photonGun_energy.pdf")
...
leg.Draw()
t2_3.DrawLatex(.62, 0.84, 'Photon particle gun')
c4.SaveAs("photonGun_PFOenergy.pdf")
...
leg.Draw()
t2_3.DrawLatex(.62, 0.84, 'Photon particle gun')
c5.SaveAs("photonGun_PFOtheta.pdf")
...
leg.Draw()
t2_3.DrawLatex(.62, 0.84, 'Photon particle gun')
c6.SaveAs("photonGun_PFOtype.pdf")
...
leg.Draw()
t2_3.DrawLatex(.62, 0.84, 'Photon particle gun')
c8.SaveAs("photonGun_ECAL_sumE.pdf")
...
leg.Draw()
t2_3.DrawLatex(.62, 0.84, 'Photon particle gun')
c8.SaveAs("photonGun_HCAL_sumE.pdf")

# delta E sum E
c9, leg = compose_plot("delta_E_sumE", "sumE - true energy [GeV]", "Events", fFile_10, fFile_50,
                       fFile_100, fFile_500, fFile_1000, fFile_5000, [-800, 10])
leg.Draw()
t2_3.DrawLatex(.62, 0.84, 'Photon particle gun')
c9.SaveAs("photonGun_deltaE_sumE.pdf")
...
leg.Draw()
t2_3.DrawLatex(.62, 0.84, 'Photon particle gun')
c10.SaveAs("photonGun_deltaE_PFO.pdf")
